...
function trans2arch()
{
  form_ml.fl.value='archive';
  if (confirm("Вы уверены, что хотите переместить отмеченное сообщение (сообщения) в архив?")) form_ml.submit();
}
function delSelect()
{
  form_ml.fl.value='delete';
  if (confirm("Вы уверены, что хотите удалить отмеченное сообщение (сообщения)?")) form_ml.submit();
}
</script>
</head>
<body topmargin="0" marginheight="0"><form name="form_ml" action="messages.php" method="post">
<table width="100%"  cellspacing="0" cellpadding="0">
  <tr>
    <td rowspan="2"><b>Сообщения:</b>&nbsp;&nbsp;</td>
    <td rowspan="2"><img src="../../images/interface/button_active_left.gif" width="11" height="24"></td>
    <td rowspan="2" align="center" nowrap bgcolor="#EEEEEE" style="padding:0px 8px 0px 8px"><b>текущие</b></td>
    <td rowspan="2"><img src="../../images/interface/button_active_right.gif" width="11" height="24"></td>
    <td><img src="../../images/spacer.gif" width="2" height="10"></td>
    <td rowspan="2"><img src="../../images/interface/button_passive_left.gif" width="11" height="24"></td>
    <td rowspan="2" align="center" nowrap bgcolor="#CCCCCC" style="padding:0px 8px 0px 8px"><a href="../../admin/messages_archives.php" style="text-decoration:none"><strong>архив</strong></a></td>
    <td rowspan="2"><img src="../../images/interface/button_passive_right.gif" width="11" height="24"></td>
    <td width="100%"><img src="../../images/spacer.gif" width="11" height="10"></td>
  </tr>
  <tr>
    <td bgcolor="#CCCCCC"><img src="../../images/spacer.gif" width="10" height="14"></td>
    <td bgcolor="#CCCCCC"><img src="../../images/spacer.gif" width="10" height="14"></td>
  </tr>
</table>
  ...
  <tr bgcolor="#EEEEEE">
    <td colspan="9"><table width="85%" cellpadding="0"  cellspacing="0">
      <tr>
        ...
        <td align="center" nowrap><img src="../../images/arrows/arrow_sm_down_green.gif" width="14" height="12" hspace="0" vspace="0" border="1" align="absmiddle">
          <input name="input" type="checkbox" class="checkboxFilter" id="input" value="on" <?php if($wstr[0]=='1'){echo('checked');}?>>
Входящие&nbsp;&nbsp;&nbsp;  <img src="../../images/arrows/arrow_sm_up_blue.gif" width="14" height="12" hspace="0" vspace="0" border="1" align="absmiddle">
...
Исходящие</td>
  ...
  <tr>
    ...
    <td align="center" nowrap bgcolor="#CCFFCC"><table cellpadding="2"  cellspacing="1" bgcolor="#CCCCCC">
      <tr>
        <td nowrap bgcolor="#FFFFFF"><img src="../../images/arrows/arrow_sm_down_green.gif" width="14" height="12"><img src="../../images/arrows/arrow_sm_up_blue.gif" width="14" height="12"></td>
      </tr>
    </table>
      </td>
    ...
    <td align="center" bgcolor="#CCFFCC"><img src="../../images/prioritet10.gif" width="8" height="8" border="1"></td>
    </tr>
<?php
for($i=0;$i<$ms_n;$i++)
{
  ...
  <td align=center><input type=checkbox class='checkbox' name=mess_sel[$i] value=$mnum></td>
</tr>");
}
?>
</table>
...
<input type="button" name="Submit" value="Удалить из БД" style="color:#FF0000;font-weight:700" onClick="javascript: delSelect();">
<input type="button" name="Submit" value="Переместить в архив" onClick="javascript: trans2arch();">
</td>
  </tr>
</table>
