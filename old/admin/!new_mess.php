...
rows="16" id="mess" style="width:100%;font-size:9pt" onKeyDown="document.getElementById('view_message').innerHTML=this.value" onDblClick='this.rows+=14' title='Двойной щелчок увеличит область ввода текста.'>Здравствуйте.
<?php if($resp=='autor') {?>
Вы размещали на нашей торговой площадке Referats.info творческую работу '<?php echo($tema);?>'.
