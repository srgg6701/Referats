...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="arial">
  <tr>
    ...
    <td align="center" class="topDotted" nowrapclass="topDotted" style="padding-top:2px"><b><a href="/old/autors.php" class="myAccount">Мой
          раздел </a></b></td>
    ...
    <td align="center" class="topDotted" nowrapclass="topDotted" style="padding-top:2px"><a href="/old/feedback.php">Обратная
        связь</a> </td>
  </tr>
  <tr valign="bottom">
    <td height="20" colspan="7" align="center" nowrap background="/images/bankreferatov_bg.gif"><b style="font-weight:100"><a href="linx1.htm" style="text-decoration:none;cursor:text;color:#000000" onMouseOver="window.status=''; return true;"><span class="lBg">Банк
            рефератов, курсовых, дипломных работ.</span></a><a href="linx3.php" style="text-decoration:none;cursor:text;color:#000000" onMouseOver="window.status=''; return true;"><span class="lBg"> Готовые
      работы, дипломы на заказ, рефераты</span></a></b></td>
  </tr>
</table>
<div style="height:4px"><img src="/images/spacer.gif"></div>
</form>
</body>
</html>
