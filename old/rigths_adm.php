...
<a href="admin/home.php">На главную</a> <a href="../index.php">Выход</a>
...
<select name="user" onChange="window.top.location.href='rigths_adm.php?user='+this.options[this.selectedIndex].value">
