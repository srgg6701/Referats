...
<table width="100%"  cellspacing="0" cellpadding="0">
  <tr>
    <td width="100%" nowrap><h4><font face="Courier New, Courier, mono">[<a href="../home.php" target="mainFrame" class="style1" title="Go Home, Amogo! :)">Admin</a>].</font><a href="file:///D|/AppServ/www/index.php" target="_top" class="style1 red" title="Переход в публичный раздел">referats.info</a></h4></td>
    <td align="right" nowrap>
      <select name="worx" onChange="MM_jumpMenu('parent.frames[\'mainFrame\']',this,1)">
  <option value="../0" selected style="background-color:#DEFFCE">-ЗАКАЗЫ-</option>
  ...
  <option value="../applications_paid.php?title=Архив&amp;where= AND ri_zakaz.status=6">&Oslash; Архив</option>
        ...
        <option value="../0" selected style="background-color:#66FFFF">-Сообщения-</option>
        ...
        <option value="messages.php?status=-1&amp;input=on&amp;output=on&amp;fl=filter&amp;autors=&amp;last_status=-2">@&loz; Архив</option></select><!--MM_jumpMenu('parent.frames[\'mainFrame\']',this,1)--><select name="service" onChange="if (this.options[this.selectedIndex].value) window.top.mainFrame.location.href=this.options[this.selectedIndex].value; this.selectedIndex=0;">
          <option value="0" selected style="background-color:#DFDDFF">-Сервис-</option>
		 <option value="" style="color: #9900CC">---Список работ:</option>
		  <option value="worx.php">&infin; ОБЗОР</option>
	      <option value="worx.php?only_new=on">&iquest; Неутверждённые</option>
 	      <option value="worx.php?only_reconfirm=on">&ne; Отложенные</option>
  		 <option value="worx.php?only_new=off">&#8226; Утвержденные</option>
		 <option value="" style="color: #9900CC">---Прочие данные:</option>
          <option value="autors.php">&sect; Авторы</option>
          <option value="!application_customers.php">&Auml; Заказчики</option>	
          <option value="!order_customers.php">&Aring; Клиенты</option>	
          <option value="money.php">$ Движение Д/С</option>
		  <option value="docs/">&part; Документация</option>
      </select><select name="statistics" onChange="MM_jumpMenu('parent.frames[\'mainFrame\']',this,1)">
          <option value="../0" selected style="background-color:#F2DBF2">-Статистика-</option>
          <option value="../searchers.php">&#8240; Посещаемость</option>
          <option value="../!/!queries.php">&plusmn; Запросы</option>
          <option value="../!/!pages_statistics.php">&para; Разделы</option>
      </select><select name="admin" onChange="jumpMenu('parent.frames[\'mainFrame\']',this,1)">
        <option value="0" selected style="background-color: #FFE9D2">-Администрирование-</option>
 	   ...
 	   <option value="reminder.php">&scaron; Настройка уведомлений</option>
