...
<html>
<head>
<title>Оплата почтовым переводом</title>
...
<!-- #EndLibraryItem --><h5 class="header10bottom"><span style="font-weight:200">			  Выбранный способ оплаты:</span> почтовый перевод</h5>
			  <p>Данные для почтового перевода: </p>
              <p>347900, Ростовская обл., г. Таганрог, главпочтамт, Клевцову
                Сергею Владимировичу</p>
                        <input type="button" name="Button" value="Подтвердить!" onClick="location.href='thanx.php?srok=post'">
  ...
  <span class="arial">После перевода денег в наш кошелёк отправьте нам соответствующее извещение на <img src="../../images/mail_payment.gif" align="absbottom"> </span>  <span class="arial"><br>
  <br>
  Это может существенно ускорить начало процесса выполнения Вашего заказа
