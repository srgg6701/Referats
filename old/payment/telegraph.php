...
<html>
<head>
<title>Оплата телеграфным переводом</title>
...
<!-- #EndLibraryItem --><h5 class="header10bottom"><span style="font-weight:200">Выбранный способ оплаты:</span> телеграфный перевод</h5>
			  <p>Данные для почтового перевода: </p>
              <p>347900, Ростовская обл., г. Таганрог, главпочтамт, Клевцову
                Сергею Владимировичу</p>
                        <input type="button" name="Button" value="Подтвердить!" onClick="location.href='thanx.php?srok=telegraph'">
            ...
            <span class="arial">После перевода денег пожалуйста, отсканируйте и пришлите нам копию квитанции на адрес <img src="../../images/mail_payment.gif" align="absbottom"><br>
            <br>
