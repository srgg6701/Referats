...
<html>
<head>
<title>Перечисление наличных</title>
...
<!-- #EndLibraryItem --><h5 class="header10bottom"><span style="font-weight:200">Выбранный способ оплаты:</span> перечисление наличных </h5>
			  <p>Сделайте следующее: </p>
              <ol>
                <li>Распечатайте <a href="#bill">квитанцию</a> (см. ниже). Для
                  этого щёлкните по ней правой кнопкой мыши и в появившемся меню
                  выберите пункт &laquo;Печать рисунка...&raquo;.</li>
                <li>Впишите свои данные: имя, фамилию, дату и сумму платежа в
                  руб. (остальные данные в квитанции уже приведены), распишитесь.</li>
                <li>Отдайте квитанцию кассиру в банке (обычно это отдел для приёма
                  коммунальных платежей, но может быть и другой) и заплатите
                  по ней.</li>
                <li>На адрес <img src="../../images/mail_payment.gif" width="128" height="13" align="absbottom"> отправьте, пожалуйста, следующую
                  информацию: </li>
              </ol>
              <ul>
                <li>Дата оплаты</li>
                <li> Сумма оплаты</li>
                <li> Свой e-mail </li>
                <li> Отсканированный корешок квитанции. Как только мы получим
                  его, приступим к выполнению Вашего заказа.</li>
              </ul>
            ...
            <span class="arial">После перевода денег отправьте нам отсканированную
            копию квитанции на адрес<img src="../../images/mail_payment.gif" align="absbottom"></span><span class="arial">или
            ...
            <br>
Это может существенно ускорить начало процесса выполнения Вашего заказа </span><!-- #BeginLibraryItem "/Library/block_if_questions.lbi" --><span class="arial"><hr size="1" noshade color="#FF9900">
...
<!-- #EndLibraryItem --></td>
        ...
        <tr>
          <td colspan="2" valign="top"><a name="bill"><img style="border-bottom:solid 1px;" src="http://www.diplom.com.ru/images/kvitancia.gif" width="756" height="513"></a><br>
                        <input type="button" name="Button" value="Подтвердить!" onClick="location.href='thanx.php?srok=cash'">
</td>
        </tr>
      </table>        
      </td>
