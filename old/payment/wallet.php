...
<html>
<head>
<title>Перевод в кошелёк WebMoney или Яндекс.деньги. Помощь с налогами. Налоговая отчётность и бухгалтерское сопровождение</title>
...
<!-- #EndLibraryItem --><h5 class="header10bottom"><span style="font-weight:200">Выбранный способ оплаты:</span> перевод в кошелёк WebMoney или Яндекс.деньги</h5>
			  <img src="../../images/logo_wm.gif" width="113" height="36"> <br>
  Номера наших кошельков на <a href="http://www.webmoney.ru"  id="normal100">WebMoney</a>:
              
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="solidGray">
                <tr valign="bottom" bgcolor="#FFFFFF">
                  <td width="100%" height="20" class="dotted-bottom">Для оплаты
                    в долларах (USD) </td>
                  <td class="dotted-bottom"><font color="#009900" size="2">Z975922213018</font></td>
                </tr>
                <tr valign="bottom" bgcolor="#FFFFFF">
                  <td height="20" class="dotted-bottom">Для оплаты в рублях (RUR) </td>
                  <td class="dotted-bottom"><font color="#CC0000" size="2">R190496965648</font></td>
                </tr>
                <tr valign="bottom" bgcolor="#FFFFFF">
                  <td height="20">Для оплаты в евро (EUR) </td>
                  <td><font color="#6600CC" size="2">E833960008390</font></td>
                </tr>
              </table>
              <br>
              <img src="../../images/ya.gif" width="44" height="27" vspace="2"><img src="../../images/logo-yandex.gif" width="64" height="28">
              <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#cccccc" class="solidGray">
                <tr valign="bottom" bgcolor="#FFFFFF">
                  <td width="100%" height="20"><font size="2">Номер
                      нашего кошелька в <a href="http://money.yandex.ru">Яндекс-деньги</a>:</font></td>
                  <td align="center"><p>41001184056254</p></td>
                </tr>
              </table>
              <br>
              <input type="button" name="Button" value="Подтвердить!" onClick="location.href='thanx.php?srok=wallet'">
		  </td><td width="30%" valign="top" class="rightTD" style="border-left:dotted 1px #ffcc00"><h2 class="header6bottom"><strong>Внимание!</strong></h2>
            <span class="arial">В примечаниях к переводу средств пожалуйста, укажите свои данные:
            </span>
            <ul class="arial">
              <li>ФИО</li>
              <li>E-mail</li>
              <li>За какую услугу Вы перечисляете деньги</li>
            </ul>
            <span class="arial">После перевода денег сообщите нам об этом по e-mail.
            </span><!-- #BeginLibraryItem "/Library/block_if_questions.lbi" --><span class="arial"><hr size="1" noshade color="#FF9900">
