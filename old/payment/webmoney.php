...
<html>
<head>
<title>Оплата через обменный пункт WebMoney</title>
...
<!-- #EndLibraryItem --><h5 class="header10bottom"><span style="font-weight:200">			  Выбранный способ оплаты:</span> обменный пункт WebMoney</h5>
			  <img src="../../images/logo_wm.gif" width="113" height="36"> <br>
              Обменные пункты WebMoney позволяют Вам перечислять деньги в чей-либо
              кошелек, не становясь участником системы.
              <p>В общих чертах схема обмена выглядит так: Вы либо платите наличными
                представителю обменного пункта, либо перечисляете ему деньги
                на банковский счёт (предварительно заполнив заявку на перевод
                средств), а он, в свою очередь, переводит эти деньги на укзанный
                Вами WM ID и кошелёк. </p>
              <p>Наши данные:</p>
              ...
              <p>Детальная информация по процедуре перевода средств через обменные
                пункты находится <a href="http://www.webmoney.ru/rus/cooperation/exchange/interexchange.shtml">здесь</a>.</p>
                        <input type="button" name="Button" value="Подтвердить!" onClick="location.href='thanx.php?srok=webmoney'">
            ...
            <span class="arial">После перевода денег в наш кошелёк отправьте
              нам соответствующее извещение на <img src="../../images/mail_payment.gif" align="absbottom">
            </span>            
            <hr size="1" noshade color="#FF9900"><!-- #BeginLibraryItem "/Library/block_if_questions.lbi" --><span class="arial"><hr size="1" noshade color="#FF9900">
